...
export const register = async (username, email, name, password) => {
    const response = await api.post('/register/', {username:username, email:email, name:name, password:password});
    return response.data
}
